...
export class USDT_WBNB_PAIR__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDT_WBNB_PAIR__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class USDT_WBNB_PAIR extends ethereum.SmartContract {
  static bind(address: Address): USDT_WBNB_PAIR {
    return new USDT_WBNB_PAIR("USDT_WBNB_PAIR", address);
  }
  ...
  burn(to: Address): USDT_WBNB_PAIR__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new USDT_WBNB_PAIR__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<USDT_WBNB_PAIR__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new USDT_WBNB_PAIR__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): USDT_WBNB_PAIR__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new USDT_WBNB_PAIR__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<USDT_WBNB_PAIR__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDT_WBNB_PAIR__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
